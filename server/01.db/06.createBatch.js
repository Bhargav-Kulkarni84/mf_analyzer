...
async function createBatch(){
    ...
    //0.Initialize timer to compute the time for processing all the fund.
    let startTime = Date.now();

    //1.Select every entry from the funds table for which nav data hasn't been downloaded.
    ...
    if(funds.length === 0){
        ...
        console.log(`Message from 06.createBatch.js at line 42.\n`);
        return;
    } 
